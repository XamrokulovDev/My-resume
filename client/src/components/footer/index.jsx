      ...
      <div className="container bg-white flex items-center justify-between rounded-2xl p-5">
        ...
        <div className="flex items-center gap-4">
          <a href="tel:+998900302423">
            <FaPhoneVolume className="text-xl max-md:text-lg text-green-500" />
          </a>
          <a href="https://t.me/Ulfatjon19" target="_blank">
            <SiTelegram className="text-xl max-md:text-lg text-blue-500" />
          </a>
          <a href="https://github.com/XamrokulovDev" target="_blank">
            <ImGithub className="text-xl max-md:text-lg text-black" />
          </a>
          <a href="https://www.youtube.com/@xamrokulov_blogs" target="_blank">
            <FaYoutube className="text-2xl max-md:text-xl text-red-500" />
          </a>
        </div>
      </div>
    </motion.footer>
